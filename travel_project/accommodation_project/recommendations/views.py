...
def recommendation_result(request, pref_id):
    ...
    return render(
        ...
        'recommendations/recommendation_result.html',
        {
            ...
            'current_type': (preference_accommodation_types(active_preference) or [""])[0],
            ...
            'current_price_min': node_value(active_preference, "budget_min") or request.GET.get("budget_min", ""),
            'current_price_max': node_value(active_preference, "budget_max") or request.GET.get("budget_max", ""),
            ...
            'current_check_in': request.GET.get("check_in", ""),
            'current_check_out': request.GET.get("check_out", ""),
            'current_promos': request.GET.getlist("promo"),
            'current_ratings': request.GET.getlist("rating"),
